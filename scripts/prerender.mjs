...
const seoPages = JSON.parse(await fs.readFile(path.join(ROOT, "src/data/seo-pages.json"), "utf8"));
const aiGuides = JSON.parse(await fs.readFile(path.join(ROOT, "src/data/ai-guides.json"), "utf8"));
const pages = [...seoPages, ...aiGuides];
