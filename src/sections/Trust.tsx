...
const readyPoints = [
  {
    title: "Готовая установка — основной сценарий",
    text: "Баню собираем в цеху и привозим готовой, когда к месту установки есть подходящий подъезд для манипулятора.",
  },
  {
    title: "Если заезда нет — решаем это до заказа",
    text: "Для моделей Квадро возможна поэтапная сборка на участке. Способ монтажа, основание и точку разгрузки согласуем заранее.",
  },
  {
    title: "Цена читается до звонка",
    text: "Для Квадро на сайте показана стандартная комплектация: печь, бак, дымоход, базовая электрика, мебель по модели, трапики, ступенька, установка на блоки и доставка по Омску.",
  },
  {
    title: "Можно проверить образец вживую",
    text: `На площадке ${company.showroom} можно зайти внутрь, оценить реальные размеры, кедровый брус, печь, дымоход и качество сборки.`,
  },
];
      ...
      <div className="mx-auto grid max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-[0.82fr_1.18fr] lg:gap-20 lg:px-8">
        <div className="reveal lg:sticky lg:top-24 lg:self-start">
          ...
          <h2 id="ready-title" className="mt-4 max-w-xl font-display text-[30px] font-semibold leading-[1.1] tracking-tight sm:text-4xl lg:text-[48px]">
            Готовая баня — <span className="text-cedar-700">без лишней неопределённости.</span>
          </h2>
          <p className="mt-5 max-w-lg text-base leading-relaxed text-bark-600 sm:text-lg">
            Сначала проверяем модель, комплектацию и условия участка. Потом понятен сценарий: привезти готовой или собрать на месте, если подъезд ограничен.
          </p>
...
const faqs = [
  {
    ...
    a: "Для моделей Квадро в стандарт входит установка на блоки. До доставки нужно согласовать ровное место установки и условия подъезда. Если участок сложный, основание и способ монтажа проверяем отдельно.",
  },
  {
  ...
  },
  {
    ...
    a: "Да, Квадро используют и в холодное время. В конструкции: кедровый брус 45 мм камерной сушки, каолиновая вата в проходе печи и сэндвич-дымоход. Конкретное время прогрева и расход дров зависят от погоды, режима топки и эксплуатации — универсальные цифры на сайте не обещаем.",
  },
  {
    q: "Нужно ли подводить воду?",
    a: "Нет, это не обязательное условие для первого запуска. В стандартной комплектации есть бак из нержавеющей стали на 50 л. Водопровод можно подключить по желанию.",
  },
  {
    q: "Цена на сайте — это вся баня или только коробка?",
    a: "Для Квадро указана цена стандартной комплектации. В неё входят конструкция, печь Aston 16, дымоход, бак 50 л, базовая электрика и мебель по модели, трапики, ступенька, установка на блоки и бесплатная доставка по Омску. Дополнительные опции считаются отдельно.",
  },
  {
