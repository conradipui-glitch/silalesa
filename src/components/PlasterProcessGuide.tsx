  ...
  return (
    <section aria-labelledby="p01-visual-title" className="bg-cream-100 py-14 text-bark-950 sm:py-20">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <p className="mt-7 text-sm leading-relaxed text-bark-700">Подробности об условиях работы, материалах и цене — на <Link className="font-semibold text-cedar-800 underline underline-offset-4" to={serviceUrl}>странице механизированной штукатурки</Link>. Ручной метод приведён для сравнения, не как отдельная услуга «Силы Леса».</p>
      </div>
    </section>
  );
}
